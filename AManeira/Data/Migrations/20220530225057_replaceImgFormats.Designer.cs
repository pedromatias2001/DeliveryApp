...
namespace AManeira.Data.Migrations
{
    ...
    [Migration("20220530225057_replaceImgFormats")]
    partial class replaceImgFormats
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AManeira.Models.Pratos", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Descricao = "Pizza de 4 Queijos com orégãos",
                            Foto = "pizza1.jpg",
                            Nome = "Pizza",
                            NumStock = 7,
                            Preco = 7.5
            ...
            modelBuilder.Entity("EncomendasPratos", b =>
                {
                    b.Property<int>("ListaEncomendasId")
                        .HasColumnType("int");

                    b.Property<int>("ListaPratosId")
                        .HasColumnType("int");

                    b.HasKey("ListaEncomendasId", "ListaPratosId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "a",
                            ConcurrencyStamp = "daabd203-5edd-45dd-924c-8589262bfcd7",
                            Name = "Admin",
                        ...
                        {
                            Id = "c",
                            ConcurrencyStamp = "f2137e02-4995-421e-9f97-6a236f636906",
                            Name = "Cliente",
            ...
            modelBuilder.Entity("EncomendasPratos", b =>
                {
                    b.HasOne("AManeira.Models.Encomendas", null)
                        .WithMany()
                        .HasForeignKey("ListaEncomendasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AManeira.Models.Pratos", null)
                        .WithMany()
